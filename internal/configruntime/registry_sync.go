...
type RegistrySyncStore interface {
	ListDrivers(ctx context.Context) ([]*v2core.AgentDriver, error)
	ListProfiles(ctx context.Context) ([]*v2core.AgentProfile, error)
	UpsertDriver(ctx context.Context, d *v2core.AgentDriver) error
	UpsertProfile(ctx context.Context, p *v2core.AgentProfile) error
