...
func (s *probeRuntimeStub) Acquire(context.Context, SessionAcquireInput) (*SessionHandle, error) {
	return nil, errors.New("not implemented")
}

func (s *probeRuntimeStub) StartExecution(context.Context, *SessionHandle, string) (string, error) {
	return "", errors.New("not implemented")
}

func (s *probeRuntimeStub) WatchExecution(context.Context, string, int64, EventSink) (*ExecutionResult, error) {
	return nil, errors.New("not implemented")
}

func (s *probeRuntimeStub) RecoverExecutions(context.Context, time.Time) ([]ExecutionRuntimeStatus, error) {
	return nil, nil
}
...
func (s *probeRuntimeStub) Release(context.Context, *SessionHandle) error { return nil }
