...
func runBuiltinGitCommitPush(ctx context.Context, store core.Store, bus core.EventBus, tokens GitHubTokens, step *core.Step, execRec *core.Execution) error {
	if store == nil {
	...
	message := "chore: ai-flow v2 update"
	if step.Config != nil {
