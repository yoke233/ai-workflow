...
func (w *ExecutorWorker) handleProbeRequest(msg *nats.Msg) {
	var req natsExecutionProbeRequest
	if err := json.Unmarshal(msg.Data, &req); err != nil {
		w.respondProbe(msg, natsExecutionProbeResponse{
			Reachable:  false,
			Answered:   false,
...
func (w *ExecutorWorker) respondProbe(msg *nats.Msg, res natsExecutionProbeResponse) {
