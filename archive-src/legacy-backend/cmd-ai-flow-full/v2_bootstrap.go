...
func bootstrapV2(v1StorePath string, roleResolver *acpclient.RoleResolver, bootstrapCfg *config.Config, ghTokens v2GitHubTokens, upgradeFn v2engine.UpgradeFunc) (*v2sqlite.Store, v2core.AgentRegistry, *configruntime.Manager, func(), func(chi.Router)) {
	...
	runtimeManager := buildV2RuntimeManager(v2Store)
